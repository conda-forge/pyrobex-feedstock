...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyrobex-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13280&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyrobex-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyrobex` can be installed with:

```
conda install pyrobex
```

It is possible to list all of the versions of `pyrobex` available on your platform with:
